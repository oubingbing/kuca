      ...
      <div class="row">
        <div class="tm-top-header-inner">
          <div class="tm-logo-container">
            <img src="/Public/img/logo.png" alt="Logo" class="tm-site-logo">
 ...
 <section class="tm-welcome-section">
  <div class="container tm-position-relative">
    <div class="tm-lights-container">
      <img src="/Public/img/light.png" alt="Light" class="light light-1">
      <img src="/Public/img/light.png" alt="Light" class="light light-2">
      <img src="/Public/img/light.png" alt="Light" class="light light-3">  
    </div>        
    <div class="row tm-welcome-content">
      <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="/Public/img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Welcome To&nbsp;&nbsp;<img src="/Public/img/header-line.png" alt="Line" class="tm-header-line"></h2>
    </p>
    <a href="/index.php/home/Visitor/index" class="tm-more-button tm-more-button-welcome" style="">Kuca Room</a> 
    ...
    <img src="/Public/img/table-set.png" alt="Table Set" class="tm-table-set img-responsive"> 
  </div>      
</section>
    ...
    <section class="tm-section row">
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 tm-welcome-img-container">
        <div class="inline-block shadow-img">
          <img src="/Public/img/kabu.jpg" alt="Image" class="img-circle img-thumbnail">  
        </div>              
      </div>            
    </section> 
    <section class="tm-section">
      <div class="row">
        <div class="col-lg-12 tm-section-header-container">
          <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="/Public/img/logo.png" alt="Logo" class="tm-site-logo">kuca blackboard</h2> 
      ...
      <div class="row">
        <div class="tm-daily-menu-container margin-top-60">
          <div class="col-lg-4 col-md-4">
            <img src="/Public/img/menu-board.png" alt="Menu board" class="tm-daily-menu-img">      
          </div>            
    ...
    <div class="container">
      <div class="row margin-bottom-60">
        <nav class="col-lg-3 col-md-3 tm-footer-nav tm-footer-div">
          ...
          <ul>
            <li><a href="/index.php/home/index/aboutus">关于我们</a></li>
            <li><a href="/index.php/home/index/culture">古卡文化</a></li>
            <li><a href="/index.php/home/index/team">古卡团队</a></li>
          </ul>
        </nav>
        ...
        <div class="col-lg-4 col-md-4 tm-footer-div">
          ...
          <div class="tm-social-icons-container">
            ...
            <p>QQ：928861455</p>
            <p>电话：15767089608</p>
            <p>微信公众号：古卡老屋(gukalaowu)<br><br><img src="/Public/img/erweima.jpg" style="width:200px"></p>
          </div>
        </div>
      </div>          
    </div>  
...
<script type="text/javascript" src="/Public/js/templatemo-script.js"></script>      
</body>
</html>