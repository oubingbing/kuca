...
<body>
	...
	<header class="mui-bar mui-bar-nav header">
		...
		<h1 id="title" class="mui-title"><a href="<?php echo U('Index/index');?>"><?php echo ($username); ?>兼职费用</a></h1>
	</header>
			...
			<!--当天签到-->
					...
					<div id="scroll1" class="mui-scroll-wrapper">
						<div class="mui-scroll">
							<ul class="mui-table-view" id="ul1">
								<?php if(is_array($monthData)): foreach($monthData as $key=>$data): ?><li class="mui-table-view-cell mui-media">
										<a>
				...
				<div id="item2mobile" class="mui-slider-item mui-control-content">
					...
					<div id="scroll2" class="mui-scroll-wrapper">
						...
						<!--当月兼职详情-->
						<ul class="mui-table-view" id="ul1">
								<?php if(is_array($ret)): foreach($ret as $key=>$data): ?><li class="mui-table-view-cell mui-media">
										<a>
											<div class="mui-media-body">
												<p class='mui-ellipsis'>
													<?php echo ($data["username"]); ?>　<span style="float:right">签到时间:<?php echo (date("Y-m-d H:i",$data["startime"])); ?></span>
